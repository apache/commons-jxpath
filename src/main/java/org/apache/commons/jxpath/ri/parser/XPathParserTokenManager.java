...
protected Token jjFillToken()
{
   ...
   final Token t = TokenFactory.createToken(jjmatchedKind, jjstrLiteralImages, input_stream);
   return t;
}
...
class TokenFactory {
   public static Token createToken(int ofKind, String[] strLiteralImages, SimpleCharStream input_stream) {
      final Token t = Token.newToken(ofKind);
      t.kind = ofKind;
      final String im = strLiteralImages[ofKind];
      t.image = im == null ? input_stream.GetImage() : im;
      t.beginLine = input_stream.getBeginLine();
      t.beginColumn = input_stream.getBeginColumn();
      t.endLine = input_stream.getEndLine();
