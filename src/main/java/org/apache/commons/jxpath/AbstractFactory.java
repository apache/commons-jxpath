...
/**
 * The {@link JXPathContext#createPath JXPathContext.createPath()} method of JXPathContext can create missing objects as it traverses an XPath; it utilizes an
...
public abstract class AbstractFactory {
     ...
     * @param parent  is the object that will serve as a parent of the new object
     * @param name    is the name of the child of the parent that needs to be created. In the case of DOM may be qualified.
     * @param index   is used if the pointer represents a collection element. You may need to expand or even create the collection to accommodate the new
     *                element.
     *
