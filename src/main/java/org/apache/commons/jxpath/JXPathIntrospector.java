...
/**
 * JXPathIntrospector maintains a registry of {@link JXPathBeanInfo JXPathBeanInfo} objects for Java classes.
 */
public class JXPathIntrospector {
    ...
    /**
     * Creates and registers a JXPathBeanInfo object for the supplied class. If the class has already been registered, returns the registered JXPathBeanInfo
     * object.
     * <p>
    ...
    /**
     * Automatically creates and registers a {@link JXPathBeanInfo} object for the specified class. That object returns true to
